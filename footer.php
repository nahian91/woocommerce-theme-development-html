<div class="rts-shorts-service-area section-gap bg_primary">
            ...
            <div class="row g-5">
                <div class="col-lg-3">
                    ...
                    <div class="single-short-service-area-start">
                        <div class="icon-area">
                            <img src="assets/images/icons/15.svg" alt="">                               
                        </div>
                ...
                <div class="col-lg-3">
                    ...
                    <div class="single-short-service-area-start">
                        <div class="icon-area">
                            <img src="assets/images/icons/16.svg" alt="">               
                        </div>
                        <div class="information">
                ...
                <div class="col-lg-3">
                    ...
                    <div class="single-short-service-area-start">
                        <div class="icon-area">
                            <img src="assets/images/icons/17.svg" alt="">                        
                        </div>
                        <div class="information">
    ...
    <script src="assets/js/theasticky.min.js"></script>
